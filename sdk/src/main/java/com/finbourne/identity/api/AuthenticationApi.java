...
public class AuthenticationApi {
     ...
     */
    public okhttp3.Call getSupportRolesCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call getSupportRolesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getSupportRolesCall(_callback);
        return localVarCall;
     ...
     */
    public SupportRolesResponse getSupportRoles() throws ApiException {
    ...
    /**
     * [EARLY ACCESS] GetSupportRoles: Get mapping of support roles, the internal representation to a human friendly representation (asynchronously)
     * Get mapping of support roles, the internal representation to a human friendly representation
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getSupportRolesAsync(final ApiCallback<SupportRolesResponse> _callback) throws ApiException {
