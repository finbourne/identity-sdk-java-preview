...
public class ApplicationMetadataApi {
    ...
    /**
     * Build call for getRegistrationAvailability
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Registration availability state </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getRegistrationAvailabilityCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/metadata/eap";
    ...
    private okhttp3.Call getRegistrationAvailabilityValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getRegistrationAvailabilityCall(_callback);
        return localVarCall;
     ...
     */
    public String getRegistrationAvailability() throws ApiException {
        ApiResponse<String> localVarResp = getRegistrationAvailabilityWithHttpInfo();
     ...
     */
    public ApiResponse<String> getRegistrationAvailabilityWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getRegistrationAvailabilityValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetRegistrationAvailability: Check Registration availability (asynchronously)
     * Identify whether there registrations service is available
     ...
     */
    public okhttp3.Call getRegistrationAvailabilityAsync(final ApiCallback<String> _callback) throws ApiException {
        okhttp3.Call localVarCall = getRegistrationAvailabilityValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
