...
public class PersonalAuthenticationTokensApi {
     ...
     */
    public okhttp3.Call createApiKeyCall(CreateApiKey createApiKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createApiKeyValidateBeforeCall(CreateApiKey createApiKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createApiKeyCall(createApiKey, _callback);
        return localVarCall;
     ...
     */
    public CreatedApiKey createApiKey(CreateApiKey createApiKey) throws ApiException {
    ...
    /**
     * [EARLY ACCESS] CreateApiKey: Create a Personal Access Token (asynchronously)
     * Generates a Personal Access Token and returns the new key and its associated metadata.
     * @param createApiKey The request to create a new Personal Access Token (required)
     ...
     */
    public okhttp3.Call createApiKeyAsync(CreateApiKey createApiKey, final ApiCallback<CreatedApiKey> _callback) throws ApiException {
     ...
     */
    public ApiKey deleteApiKey(String id) throws ApiException {
     ...
     */
    public ApiResponse<ApiKey> deleteApiKeyWithHttpInfo(String id) throws ApiException {
    ...
    /**
     * [EARLY ACCESS] DeleteApiKey: Invalidate a Personal Access Token (asynchronously)
     * Immediately invalidates the specified Personal Access Token
     * @param id The id of the Personal Access Token to delete (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteApiKeyAsync(String id, final ApiCallback<ApiKey> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call listOwnApiKeysCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call listOwnApiKeysValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listOwnApiKeysCall(_callback);
        return localVarCall;
     ...
     */
    public List<ApiKey> listOwnApiKeys() throws ApiException {
    ...
    /**
     * [EARLY ACCESS] ListOwnApiKeys: Gets the meta data for all of the user&#39;s existing Personal Access Tokens. (asynchronously)
     * Gets the meta data for all of the user&#39;s Personal Access Tokens that have not been deleted. They may be  invalid due to the deactivation date having passed.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call listOwnApiKeysAsync(final ApiCallback<List<ApiKey>> _callback) throws ApiException {
