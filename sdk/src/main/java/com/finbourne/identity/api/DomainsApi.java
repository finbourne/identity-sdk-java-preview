...
public class DomainsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 404 </td><td> The agreement is not signed </td><td>  -  </td></tr>
        <tr><td> 200 </td><td> The agreement is signed </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public void getAgreement(String agreement) throws ApiException {
        getAgreementWithHttpInfo(agreement);
    }
     ...
     */
    public ApiResponse<Void> getAgreementWithHttpInfo(String agreement) throws ApiException {
     ...
     */
    public okhttp3.Call getAgreementAsync(String agreement, final ApiCallback<Void> _callback) throws ApiException {
