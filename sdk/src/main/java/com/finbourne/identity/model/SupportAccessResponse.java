...
public class SupportAccessResponse {
  ...
  private List<String> permittedRoles = null;
  ...
  **/
  @ApiModelProperty(value = "A list of permitted roles, valid for support staff to assume, for the duration of the access request")
